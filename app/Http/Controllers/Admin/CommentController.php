...
use App\Http\Requests\StoreUpdateCommentReq;
...
class CommentController extends Controller
{
    ...
    public function store(StoreUpdateCommentReq $request, $userId)
    {
        if (!$user = $this->user->find($userId)) {
            return redirect()->back();
        }
    ...
    public function update(StoreUpdateCommentReq $request, $id)
    {
        if (!$comment = $this->comment->find($id)) {
            return redirect()->back();
        }
